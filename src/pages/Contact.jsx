      ...
      <div className="contact_container container grid">
        <div className="contact_data">
          ...
          <p className="contact_description">
            Caso tenha gostado do meu trabalho, <br /> preencha o formulário ao
            lado e envie <br /> um e-mail para mim. Se preferir, também <br />{" "}
            pode entrar em contato através do <br /> WhatsApp logo abaixo:
          </p>
            ...
            <div className="button-group">
              ...
              <div
                className={`email_message ${
                  typeMessage === "success" ? "success" : "error-empty"
                } ${showMessage && "show"}`}
              >
                {typeMessage === "error-empty"
                  ? "Preencha todos os campos, por favor!"
                  : typeMessage === "success"
                  ? "E-mail enviado com sucesso!"
                  : typeMessage === "error"
                  ? "Houve um problema ao enviar o email, tente novamente!"
                  : ""}
              </div>
            </div>
          </div>
