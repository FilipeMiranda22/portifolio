...
export const stats = [
  {
    id: 1,
    no: '4+',
    title: 'Anos cursando <br /> Engenharia de Computação no IFPB - Campina Grande',
  },

  {
    id: 2,
    no: '6+',
    title: 'Projetos Completos e alguns outros já em andamento. <br />Alguns estão disponíveis para demonstração na próxima sessão.',
  },

  {
    id: 3,
    no: '10+',
    title: 'Tenho uma diversidade de certificados abrangendo diferentes áreas, incluindo postura profissional, análise de dados e desenvolvimento web.',
  },
    ...
    details: [
      {
        icon: <FiFileText />,
        title: 'Descrição: ',
        desc: 'Site desenvolvido em react, para aplicar conceitos básicos de Crud com algumas regras de negócios.',
      },
      {
        icon: <FaGithub />,
        title: 'GitHub: ',
      ...
      },
      {
        icon: <FiExternalLink />,
        title: 'Acesse: ',
        desc: 'Link ainda não disponível',
      },
    ],
  },
